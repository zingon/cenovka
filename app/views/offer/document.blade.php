  ...
  <table class="container">
    ...
    <td>
      ...
      <tbody>
        ...
        <tr id="endPrice">
                  <td class="half"></td>
                  <td class="quater b-l">Celkem k úhradě bez DPH: </td>
                  <td class="quater b-r r">{{$document->total_price_without_tax}} Kč</td>
              </tr>
                <tr id="endPrice">
                <td class="half"></td>
                <td class="quater b-l">{{$document->dph}}% DPH: </td>
                <td class="quater b-r r">{{$document->total_tax}} Kč</td>
                </tr>
                <tr id="endPrice">
                <td class="half"></td>
                <td class="quater b-l b-b"><strong>Celkem k úhradě s DPH: </strong></td>
                <td class="quater b-r b-b r"><strong>{{$document->total_price}} Kč</strong></td>
                </tr>
