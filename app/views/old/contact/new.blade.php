  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
    	...
    	<h4 class="modal-title">Nový Kontakt</h4>
   	</div>
	...
	{{Form::open(array('route'=>'contact.store','class'=>'form-horizontal','id'=>'contactForm'))}}
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{Form::text('firstname','',array('class'=>'form-control','placeholder'=>'Křestní jméno'))}}
			</div>
			
			{{Form::label('lastname','Příjmení:',array('class'=>'col-sm-2'))}}
			<div class="col-sm-4">
				{{Form::text('lastname','',array('class'=>'form-control','placeholder'=>'Příjmení'))}}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{Form::text('dic','',array('class'=>'form-control','placeholder'=>'DIČ'))}}
			</div>
			{{Form::label('ic','IČ:',array('class'=>'col-sm-2'))}}
			<div class="col-sm-4">
				{{Form::text('ic','',array('class'=>'form-control','placeholder'=>'IČ','id'=>'ic'))}}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				{{Form::text('adress','',array('class'=>'form-control','placeholder'=>'Ulice a č.p'))}}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{Form::text('city','',array('class'=>'form-control','placeholder'=>'Město'))}}
			</div>

			{{Form::label('zip_code','PSČ:',array('class'=>'col-sm-2'))}}
			<div class="col-sm-4">
				{{Form::text('zip_code','',array('class'=>'form-control','placeholder'=>'PSČ'))}}
			</div>
		</div>
